...
class PicnicBoatInsurance extends StatefulWidget {
  @override
  _PicnicBoatInsuranceState createState() => _PicnicBoatInsuranceState();
}

class _PicnicBoatInsuranceState extends State<PicnicBoatInsurance> {
  //image picker
  File _image;
