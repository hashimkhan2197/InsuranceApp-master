...
class FishingBoatInsurance extends StatefulWidget {
  @override
  _FishingBoatInsuranceState createState() => _FishingBoatInsuranceState();
}

class _FishingBoatInsuranceState extends State<FishingBoatInsurance> {
  //image picker
  File _image;
